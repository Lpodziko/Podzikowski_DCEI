...
Altering the balance of greenhouse gases in Earth's atmosphere has elevated temperatures and altered precipitation regimes across the globe; yet at a regional scale climate change can have positive, negative, and even no effect on temperature and precipitations.  Elevated atmospheric concentrations of carbon dioxide, CO~2~, are largely implicated in global climate changes over the last century.  The shift in balance of atmosphic greenhouse gases .  We explore if the temperature and precipitation in N. America, specifically in the United States, has changed since the mid-1900s.  We hope     
